...
pub struct ScoredPoint {
    #[serde(rename = "id")]
    pub id: Box<crate::models::ExtendedPointId>,
    /// Point version
    ...
    pub vector: Option<Option<Box<crate::models::VectorStruct>>>,
    #[serde(rename = "shard_key", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub shard_key: Option<Option<Box<crate::models::ShardKey>>>,
}

impl ScoredPoint {
    /// Search result
    pub fn new(id: crate::models::ExtendedPointId, version: i32, score: f32) -> ScoredPoint {
        ScoredPoint {
            id: Box::new(id),
            version,
            score,
