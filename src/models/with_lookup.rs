...
pub struct WithLookup {
    ...
    #[serde(rename = "with_vectors", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub with_vectors: Option<Option<Box<crate::models::WithVector>>>,
}

impl WithLookup {
    pub fn new(collection: String) -> WithLookup {
        WithLookup {
            collection,
            with_payload: None,
            with_vectors: None,
