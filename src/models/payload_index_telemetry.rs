...
pub struct PayloadIndexTelemetry {
    ...
    #[serde(rename = "points_values_count")]
    pub points_values_count: i32,
    #[serde(rename = "points_count")]
    pub points_count: i32,
    #[serde(rename = "histogram_bucket_size", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub histogram_bucket_size: Option<Option<i32>>,
}

impl PayloadIndexTelemetry {
    pub fn new(points_values_count: i32, points_count: i32) -> PayloadIndexTelemetry {
