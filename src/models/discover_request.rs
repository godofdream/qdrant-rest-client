...
pub struct DiscoverRequest {
    ...
    pub target: Option<Option<Box<crate::models::RecommendExample>>>,
    ...
    pub context: Option<Option<Vec<crate::models::ContextExamplePair>>>,
...
impl DiscoverRequest {
    ...
    pub fn new(limit: i32) -> DiscoverRequest {
        DiscoverRequest {
            shard_key: None,
            target: None,
            context: None,
