...
/// ShardTransferMethod : Methods for transferring a shard from one node to another.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ShardTransferMethod {
}

impl Default for ShardTransferMethod {
    fn default() -> Self {
        Self::new()
    }
}
...
impl ShardTransferMethod {
    ...
    pub fn new() -> ShardTransferMethod {
        ShardTransferMethod {
        }
    }
}
