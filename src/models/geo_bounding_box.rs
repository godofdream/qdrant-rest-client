...
/// GeoBoundingBox : Geo filter request  Matches coordinates inside the rectangle, described by coordinates of lop-left and bottom-right edges
...
pub struct GeoBoundingBox {
    ...
    pub top_left: Box<crate::models::GeoPoint>,
    #[serde(rename = "bottom_right")]
    pub bottom_right: Box<crate::models::GeoPoint>,
}

impl GeoBoundingBox {
    /// Geo filter request  Matches coordinates inside the rectangle, described by coordinates of lop-left and bottom-right edges
    pub fn new(top_left: crate::models::GeoPoint, bottom_right: crate::models::GeoPoint) -> GeoBoundingBox {
        GeoBoundingBox {
