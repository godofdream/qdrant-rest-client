...
pub struct ClusterTelemetry {
    ...
    pub status: Option<Option<Box<crate::models::ClusterStatusTelemetry>>>,
    #[serde(rename = "config", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub config: Option<Option<Box<crate::models::ClusterConfigTelemetry>>>,
}

impl ClusterTelemetry {
    pub fn new(enabled: bool) -> ClusterTelemetry {
        ClusterTelemetry {
            enabled,
            status: None,
            config: None,
