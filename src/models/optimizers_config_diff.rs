...
pub struct OptimizersConfigDiff {
    ...
    #[serde(rename = "deleted_threshold", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub deleted_threshold: Option<Option<f64>>,
    /// The minimal number of vectors in a segment, required to perform segment optimization
    #[serde(rename = "vacuum_min_vector_number", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub vacuum_min_vector_number: Option<Option<i32>>,
    ...
    #[serde(rename = "default_segment_number", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub default_segment_number: Option<Option<i32>>,
    ...
    #[serde(rename = "flush_interval_sec", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub flush_interval_sec: Option<Option<i32>>,
    /// Maximum available threads for optimization workers
    #[serde(rename = "max_optimization_threads", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub max_optimization_threads: Option<Option<i32>>,
}
...
impl OptimizersConfigDiff {
    pub fn new() -> OptimizersConfigDiff {
