...
pub struct PayloadIndexInfo {
    ...
    pub data_type: crate::models::PayloadSchemaType,
    #[serde(rename = "params", skip_serializing_if = "Option::is_none")]
    pub params: Option<Box<crate::models::TextIndexParams>>,
...
impl PayloadIndexInfo {
    ...
    pub fn new(data_type: crate::models::PayloadSchemaType, points: i32) -> PayloadIndexInfo {
        PayloadIndexInfo {
            data_type,
            params: None,
            points,
