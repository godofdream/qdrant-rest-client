...
pub struct SearchGroupsRequest {
    ...
    #[serde(rename = "vector")]
    pub vector: Box<crate::models::NamedVectorStruct>,
...
impl SearchGroupsRequest {
    pub fn new(vector: crate::models::NamedVectorStruct, group_by: String, group_size: i32, limit: i32) -> SearchGroupsRequest {
        SearchGroupsRequest {
            shard_key: None,
