...
pub enum StateRole {
    ...
    #[serde(rename = "Leader")]
    Leader,
    #[serde(rename = "PreCandidate")]
    PreCandidate,

}

impl ToString for StateRole {
    fn to_string(&self) -> String {
        match self {
            Self::Follower => String::from("Follower"),
            Self::Candidate => String::from("Candidate"),
            Self::Leader => String::from("Leader"),
            Self::PreCandidate => String::from("PreCandidate"),
        }
    }
}
