...
pub struct CollectionsAliasesResponse {
    ...
    pub aliases: Vec<crate::models::AliasDescription>,
}

impl CollectionsAliasesResponse {
    pub fn new(aliases: Vec<crate::models::AliasDescription>) -> CollectionsAliasesResponse {
