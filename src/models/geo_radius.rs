...
/// GeoRadius : Geo filter request  Matches coordinates inside the circle of `radius` and center with coordinates `center`
...
pub struct GeoRadius {
    #[serde(rename = "center")]
    pub center: Box<crate::models::GeoPoint>,
...
impl GeoRadius {
    ...
    pub fn new(center: crate::models::GeoPoint, radius: f64) -> GeoRadius {
        GeoRadius {
