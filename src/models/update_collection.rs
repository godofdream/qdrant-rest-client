...
pub struct UpdateCollection {
    ...
    pub vectors: Option<::std::collections::HashMap<String, crate::models::VectorParamsDiff>>,
    ...
    pub params: Option<Option<Box<crate::models::CollectionParamsDiff>>>,
    ...
    pub quantization_config: Option<Option<Box<crate::models::QuantizationConfigDiff>>>,
    #[serde(rename = "sparse_vectors", skip_serializing_if = "Option::is_none")]
    pub sparse_vectors: Option<::std::collections::HashMap<String, crate::models::SparseVectorParams>>,
}
