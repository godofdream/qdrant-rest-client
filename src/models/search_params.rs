...
pub struct SearchParams {
    ...
    #[serde(rename = "hnsw_ef", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub hnsw_ef: Option<Option<i32>>,
    /// Search without approximation. If set to true, search may run long but with exact results.
    #[serde(rename = "exact", skip_serializing_if = "Option::is_none")]
    pub exact: Option<bool>,
    #[serde(rename = "quantization", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub quantization: Option<Option<Box<crate::models::QuantizationSearchParams>>>,
    ...
    #[serde(rename = "indexed_only", skip_serializing_if = "Option::is_none")]
