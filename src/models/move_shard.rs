...
pub struct MoveShard {
    ...
    pub to_peer_id: i32,
    #[serde(rename = "from_peer_id")]
    pub from_peer_id: i32,
    #[serde(rename = "method", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub method: Option<Option<Box<crate::models::ShardTransferMethod>>>,
}

impl MoveShard {
    pub fn new(shard_id: i32, to_peer_id: i32, from_peer_id: i32) -> MoveShard {
        MoveShard {
            shard_id,
            to_peer_id,
            from_peer_id,
