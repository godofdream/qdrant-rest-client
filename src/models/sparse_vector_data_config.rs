...
/// SparseVectorDataConfig : Config of single sparse vector data storage
...
pub struct SparseVectorDataConfig {
    #[serde(rename = "index")]
    pub index: Box<crate::models::SparseIndexConfig>,
}

impl SparseVectorDataConfig {
    /// Config of single sparse vector data storage
    pub fn new(index: crate::models::SparseIndexConfig) -> SparseVectorDataConfig {
