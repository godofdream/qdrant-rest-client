...
impl ToString for CompressionRatio {
    fn to_string(&self) -> String {
        match self {
            Self::X4 => String::from("x4"),
            Self::X8 => String::from("x8"),
            Self::X16 => String::from("x16"),
            Self::X32 => String::from("x32"),
