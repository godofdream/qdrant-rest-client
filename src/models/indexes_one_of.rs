...
/// IndexesOneOf : Do not use any index, scan whole vector collection during search. Guarantee 100% precision, but may be time consuming on large collections.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IndexesOneOf {
    #[serde(rename = "type")]
    pub r#type: Type,
...
impl IndexesOneOf {
    ...
    pub fn new(r#type: Type, options: serde_json::Value) -> IndexesOneOf {
        IndexesOneOf {
            r#type,
            options,
        }
