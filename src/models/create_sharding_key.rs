...
pub struct CreateShardingKey {
    ...
    pub shard_key: Box<crate::models::ShardKey>,
    /// How many shards to create for this key If not specified, will use the default value from config
    #[serde(rename = "shards_number", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub shards_number: Option<Option<i32>>,
    ...
    pub placement: Option<Option<Vec<i32>>>,
}

impl CreateShardingKey {
    pub fn new(shard_key: crate::models::ShardKey) -> CreateShardingKey {
        CreateShardingKey {
