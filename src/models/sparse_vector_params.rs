...
/// SparseVectorParams : Params of single sparse vector data storage
...
pub struct SparseVectorParams {
    ...
    pub index: Option<Option<Box<crate::models::SparseIndexParams>>>,
}

impl Default for SparseVectorParams {
    fn default() -> Self {
        Self::new()
    }
}
