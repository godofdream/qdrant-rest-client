...
pub struct AppBuildTelemetry {
    ...
    pub features: Option<Option<Box<crate::models::AppFeaturesTelemetry>>>,
    #[serde(rename = "system", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub system: Option<Option<Box<crate::models::RunningEnvironmentTelemetry>>>,
    #[serde(rename = "startup")]
    pub startup: String,
}

impl AppBuildTelemetry {
    pub fn new(name: String, version: String, startup: String) -> AppBuildTelemetry {
        AppBuildTelemetry {
            name,
            version,
            features: None,
