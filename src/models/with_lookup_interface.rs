...
pub struct WithLookupInterface {
    ...
    pub with_payload: Option<Box<crate::models::WithPayloadInterface>>,
    #[serde(rename = "with_vectors", skip_serializing_if = "Option::is_none")]
    pub with_vectors: Option<Box<crate::models::WithVector>>,
}

impl WithLookupInterface {
    pub fn new(collection: String) -> WithLookupInterface {
        WithLookupInterface {
            collection,
            with_payload: None,
            with_vectors: None,
