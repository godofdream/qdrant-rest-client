...
pub struct MessageSendErrors {
    #[serde(rename = "count")]
    pub count: i32,
    #[serde(rename = "latest_error", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub latest_error: Option<Option<String>>,
}

impl MessageSendErrors {
    /// Message send failures for a particular peer
    pub fn new(count: i32) -> MessageSendErrors {
        MessageSendErrors {
            count,
            latest_error: None,
        }
