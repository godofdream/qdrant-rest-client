...
/// DeletePayload : This data structure is used in API interface and applied across multiple shards
...
pub struct DeletePayload {
    ...
    pub points: Option<Option<Vec<crate::models::ExtendedPointId>>>,
...
impl DeletePayload {
    ...
    pub fn new(keys: Vec<String>) -> DeletePayload {
        DeletePayload {
            keys,
            points: None,
            filter: None,
