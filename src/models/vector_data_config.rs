...
pub struct VectorDataConfig {
    ...
    pub storage_type: Box<crate::models::VectorStorageType>,
    #[serde(rename = "index")]
    pub index: Box<crate::models::Indexes>,
...
impl VectorDataConfig {
    ...
    pub fn new(size: i32, distance: crate::models::Distance, storage_type: crate::models::VectorStorageType, index: crate::models::Indexes) -> VectorDataConfig {
        VectorDataConfig {
            size,
            distance,
