...
/// TrackerTelemetry : Tracker object used in telemetry
...
pub struct TrackerTelemetry {
    ...
    #[serde(rename = "segment_ids")]
    pub segment_ids: Vec<i32>,
    #[serde(rename = "status")]
    pub status: Box<crate::models::TrackerStatus>,
...
impl TrackerTelemetry {
    ...
    pub fn new(name: String, segment_ids: Vec<i32>, status: crate::models::TrackerStatus, start_at: String) -> TrackerTelemetry {
        TrackerTelemetry {
            name,
            segment_ids,
