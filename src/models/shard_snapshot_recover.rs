...
pub struct ShardSnapshotRecover {
    ...
    pub location: Box<crate::models::ShardSnapshotLocation>,
    #[serde(rename = "priority", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub priority: Option<Option<crate::models::SnapshotPriority>>,
}

impl ShardSnapshotRecover {
    pub fn new(location: crate::models::ShardSnapshotLocation) -> ShardSnapshotRecover {
