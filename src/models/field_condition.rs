...
pub struct FieldCondition {
    ...
    pub r#match: Option<Option<Box<crate::models::Match>>>,
    #[serde(rename = "range", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub range: Option<Option<Box<crate::models::Range>>>,
    #[serde(rename = "geo_bounding_box", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub geo_bounding_box: Option<Option<Box<crate::models::GeoBoundingBox>>>,
    #[serde(rename = "geo_radius", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub geo_radius: Option<Option<Box<crate::models::GeoRadius>>>,
    #[serde(rename = "geo_polygon", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub geo_polygon: Option<Option<Box<crate::models::GeoPolygon>>>,
    #[serde(rename = "values_count", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub values_count: Option<Option<Box<crate::models::ValuesCount>>>,
}

impl FieldCondition {
    /// All possible payload filtering conditions
    pub fn new(key: String) -> FieldCondition {
        FieldCondition {
            key,
            r#match: None,
            range: None,
